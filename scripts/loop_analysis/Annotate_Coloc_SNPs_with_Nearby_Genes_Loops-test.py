...
sys.argv = [0] * 8
sys.argv[1] =  'results/main/2021_Nikhil_eQTL/Results/Colocalization/T1D_34012112_Gaulton/'
sys.argv[1] += 'BLUEPRINT_eQTL_T-cell//FINAL_Summary_Coloc_Gene_SNP_Pairs.bed'
sys.argv[2] = 'results/refs/ensembl/gencode.v19.annotation.bed'
sys.argv[3] = 'results/main/2021_Nikhil_eQTL/Data/FitHiChIP_Loops/TFH/FitHiChIP_L/FitHiChIP.interactions_FitHiC_Q0.01.bed'
sys.argv[4] = 'results/refs/spp/SPP_D-Challenge_networks.xlsx'
sys.argv[5] = 'results/refs/hg19/hg19.chrom.sizes'
sys.argv[6] = 'results/main/2021_Nikhil_eQTL/Data/eqtl_sqtl_summ_stats/BLUEPRINT_eQTL/T-cell.txt.gz'
sys.argv[7] = 'results/main/loop_analysis/test/'
...
# extract colocalizing SNP-Gene pairs
final_coloc_snp_genes_pairs = master[(master.is_coloc_pair == 1)]

# make the bed for colocalized SNPs (status: running)
final_snps = final_coloc_snp_genes_pairs[['chrom', 'snp_pos', 'snp_pos', 'rs_id']]
final_snps = final_snps.loc[~final_snps.duplicated(['chrom', 'snp_pos'])]
final_snps = pbt.BedTool.from_dataframe(final_snps)
final_snps = final_snps.slop(b=500, g=gs_fn)
final_snps = final_snps.to_dataframe()
