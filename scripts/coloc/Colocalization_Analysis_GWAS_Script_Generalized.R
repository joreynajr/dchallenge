...
print(params)
# quit used for testing
quit('no')

# compiling the eqtl columns
eqtl_cols = c(parser$eqtl_chr, parser$eqtl_pos, parser$eqtl_geneName,
              parser$eqtl_dist, parser$eqtl_slope, parser$eqtl_pvalue)
