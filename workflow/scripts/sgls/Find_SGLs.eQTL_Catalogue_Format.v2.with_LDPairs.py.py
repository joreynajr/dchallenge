...
#mastermaster[master.is_eqtl_pair == 1].head()master[master.is_coloc_pair == 1].head()master[master.has_colocSNP_anchor == 1].head()master[master.has_fithichip_loop == 1].head()
#########################################################################################
# Make WashU files 
#########################################################################################
